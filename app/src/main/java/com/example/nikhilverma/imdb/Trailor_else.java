 ...
 */
public class Trailor_else {
    static String[] filming;
    static String title = "", videoURL = "";
    static List<Trailor_Model> list_te = new ArrayList<>();


    public static List<newModel> parseFeednew(String content) {
